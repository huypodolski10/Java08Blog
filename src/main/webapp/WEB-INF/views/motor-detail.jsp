            ...
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div id="motorImage" class="carousel slide" data-ride="carousel">
                        ...
                        <a class="carousel-control-prev" href="#motorImage" data-slide="prev">
                            <span class="carousel-control-prev-icon"></span>
                        </a>
                        <a class="carousel-control-next" href="#motorImage" data-slide="next">
                ...
                <div class="col-xl-6 price-block">
                    <div class="group-price">
                        ...
                        <p>Giá: <strong>990.000.000 VNĐ</strong></p>
                    ...
                    <div class="price-bike">
                        ...
                        <div class="row row-price-bike">
                            <div class="col"><i class="material-icons">location_on</i> Khu vực:</div>
                            <div class="col">
                        ...
                        <!-- Giá xe -->
                        <div class="row row-price-bike">
                            <div class="col"><i class='fas fa-dollar-sign'></i> Giá xe:</div>
                        ...
                        <!-- Thuế trước bạ -->
                        <div class="row row-price-bike">
                            <div class="col"><i class='fas fa-dollar-sign'></i> Thuế trước bạ:</div>
                        ...
                        <!-- Phí biển số -->
                        <div class="row row-price-bike">
                            <div class="col"><i class='fas fa-dollar-sign'></i> Phí biển số</div>
                            <div class="col row-price">
                        ...
                        <!-- Bảo hiểm dân sự -->
                        <div class="row row-price-bike">
                            <div class="col"><i class='fas fa-dollar-sign'></i> Bảo hiểm dân sự:</div>
                            <div class="col row-price">
                                <span>66.000VNĐ</span>
                            </div>
                        </div>
                        ...
                        <!-- Tổng cộng -->
                        <div class="row row-price-bike" style="color: red; font-weight: bold;">
                            <div class="col"><i class="fa fa-tags"></i> Tổng cộng:</div>
                            <div class="col row-price">
                        ...
                        <button type="button" class="btn btn-primary buy-field" data-toggle="modal" data-target="#buyerInfoModal">
                            <i class='fas fa-shopping-cart icon' style="color: white;"></i>
                            Đăng ký mua xe
                        </button>

                        <div class="modal fade" id="buyerInfoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="#">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="custom-control-label ml-5" for="customCheckbox">Nam</label>
                                                <!-- Female -->
                                                <input type="checkbox" class="custom-control-input" id="customCheckbox">
                                                <label class="custom-control-label ml-5" for="customCheckbox">Nữ</label>
                                            </div>
                                            <!-- Note -->
                                            <div class="form-group">
